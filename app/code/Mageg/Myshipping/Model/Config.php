<?php
namespace Mageg\Myshipping\Model;
...
class Config
{
    const XPATH_FORMAT                 = 'mageg_deliverydate/general/format';
    const XPATH_DISABLED               = 'mageg_deliverydate/general/disabled';
    const XPATH_HOURMIN                = 'mageg_deliverydate/general/hourMin';
    const XPATH_HOURMAX                = 'mageg_deliverydate/general/hourMax';
    const XPATH_REQUIRED_DELIVERY_DATE = 'mageg_deliverydate/general/required_delivery_date';
