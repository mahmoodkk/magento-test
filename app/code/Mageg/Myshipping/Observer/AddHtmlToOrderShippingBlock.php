...
class AddHtmlToOrderShippingBlock implements ObserverInterface
{
    ...
    public function execute(EventObserver $observer)
    {
        if($observer->getElementName() == 'sales.order.info') {
            ...
            if($order->getDeliveryTime() != '0000-00-00 00:00:00') {
            ...
            $deliveryDateBlock->getDeliveryTime($formattedDate);
            $deliveryDateBlock->setTemplate('Mageg_Myshipping::order_info_shipping_info.phtml');
